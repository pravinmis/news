        ...
        <div class="row">
            <div class="col-md-8">
              ...
              <div class="post-container">
                ...
                $sql="SELECT user.username FROM post JOIN user ON post.author = user.user_id WHERE post.author = {$auth_id}";
                      ...
                      $result = mysqli_query($conn,$sql) or die("QUERY failed.");
                       ...
                       ?>
                 <h2 class="page-heading"><?php echo $row['username'];
                                  ...
                                  <div class="post-information">
                                      <span>
                                        ...
                                        <span>
                                          ...
                                          <a herf='author.php?aid=<?php echo $row['author']; ?>'><?php echo $row['username']; ?></a>
                                   </span>
                                      <span>
